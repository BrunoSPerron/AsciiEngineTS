...
`anchorX` and `anchorY` pin the **center** of the element to a percentage of the container dimensions. `x` and `y` are then applied as a tile offset on top of that.

| Value          | Meaning               |
| -------------- | --------------------- |
| `anchorX: 0`   | Left edge             |
| `anchorX: 50`  | Horizontally centered |
| `anchorX: 100` | Right edge            |
| `anchorY: 0`   | Top edge              |
| `anchorY: 50`  | Vertically centered   |
| `anchorY: 100` | Bottom edge           |
